...
def make_model():
    ...
    tower_1 = Conv2D(32, (3, 3), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(input_img)
    tower_1 = Conv2D(32, (3, 3), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(tower_1)
    tower_1 = MaxPooling2D((2, 2),padding='valid')(tower_1)
    tower_1 = Conv2D(32, (3, 3), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(tower_1)
    tower_1 = Conv2D(32, (1, 1), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(tower_1)
    tower_1 = MaxPooling2D((2, 2),padding='valid')(tower_1)
    tower_1 = Conv2D(64, (1, 1), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(tower_1)
    tower_1 = Conv2D(64, (3, 3), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(tower_1)
    tower_1 = BatchNormalization(axis=3)(tower_1)

    tower_2 = Conv2D(32, (3, 3), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(input_img)
    tower_2 = Conv2D(64, (3, 3), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(tower_2)
    tower_2 = MaxPooling2D((2, 2), padding='valid')(tower_2)
    tower_2 = Conv2D(128, (1, 1), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(tower_2)
    tower_2 = Conv2D(256, (2, 2), padding='valid', activation='relu', kernel_regularizer=regularizers.l2(0.001))(tower_2)
    tower_2 = MaxPooling2D((3, 3), padding='valid')(tower_2)
...
# grab the image paths and randomly shuffle them
imagePaths2 = sorted(list(paths.list_images('C:\\Users\\User\\spn_myone\\petaug_lidc')))   # data folder with 2 categorical folders
random.seed(SEED)
...
with tf.device('/GPU:0'):
    ...
    for train_index,test_index in KFold(n_split).split(data): #data split
        ...
        print('End of Fold ',summary)
        
        #aug = ImageDataGenerator(rotation_range=10, horizontal_flip=True, vertical_flip=True, fill_mode = 'nearest')
        #aug.fit(trainX)
        #model3.fit_generator(aug.flow(trainX, trainY,batch_size=32), epochs=60, steps_per_epoch=len(trainX)//32,validation_data=(valx, valy))
